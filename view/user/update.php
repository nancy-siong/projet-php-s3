<form method="get" action="">
  ...
  <fieldset>
    ...
    <p><label for="login_id">Login :</label>
    <input 
      <?=($isUpdating ? "readonly" : "")?> 
      type="text" 
      placeholder="exemple@gmail.com" 
      name="login" id="login_id" 
      value="<?= ($isUpdating? $u->getLogin() : "") ?>" 
    /></p>


    <p><label for="surname_id">Nom :</label>
      <input 
        type="text" 
    ...
    <p><label for="name_id">Prénom :</label>
    <input 
      type="text" 
    ...
    <p><label for="password_id">Mot de passe :</label>
    <input 
    ...
    <p><label for="password_id">Confirmer le mot passe :</label>
    <input 
